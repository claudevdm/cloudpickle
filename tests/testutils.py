...
def subprocess_pickle_string(
    input_data, protocol=None, config=None, timeout=TIMEOUT, add_env=None
):
...
class _Worker:
    ...
    def run(self, func, *args, **kwargs):
        ...
        input_payload = dumps(
            (func, args, kwargs), protocol=self.protocol, config=get_config(self.config)
        )
